...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <iframe src="${pageContext.request.contextPath}/templates/user_list.jsp" frameborder="0" width="1600" height="800"></iframe>
  </div>
...
<script src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
<script>
//JavaScript代码区域
